...
!function() {
"use strict";
/* harmony import */ var flot__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(646);
/* harmony import */ var _tarekraafat_autocomplete_js_dist_autoComplete_min_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(957);
/* provided dependency */ var jQuery = __webpack_require__(755);
...
jQuery(function ($) {
  ...
  var $revenueForm = $('#revenueForm');
  var $revenueFile = document.querySelector('#revenueFile');
  var $revenueSelected = document.querySelector('#revenueForm .drag-drop__selected');
  var $revenueTextLabel = document.querySelector('#revenueForm .drag-drop__selected .filename');
  var $expensesForm = $('#expensesForm');
  var $expensesFile = document.querySelector('#expensesFile');
  var $expensesSelected = document.querySelector('#expensesForm .drag-drop__selected');
  var $expensesTextLabel = document.querySelector('#expensesForm .drag-drop__selected .filename');

  if ($('.autoComplete').length) {
    fetch('https://webapp-bb2am.ondigitalocean.app/api/sources').then( /*#__PURE__*/function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(source) {
        var data, autoCompleteJS;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 4:
                ...
                data = _context.t0.values.call(_context.t0, _context.t1);
                _context.next = 11;
                break;
              ...
              case 11:
                console.log(data);
                autoCompleteJS = new _tarekraafat_autocomplete_js_dist_autoComplete_min_js__WEBPACK_IMPORTED_MODULE_1__({
                  data: {
                    src: data,
                    cache: true
                  },
                  ...
                  resultsList: {
                    element: function element(list, data) {
                      ...
                      if (data.results.length > 0) {
                        info.innerHTML = "Displaying <strong>".concat(data.results.length, "</strong> out of <strong>").concat(data.matches.length, "</strong> results");
                      } else {
                        info.innerHTML = "\u0421\u043E\u0437\u0434\u0430\u0442\u044C \u043A\u0430\u0442\u0435\u0433\u043E\u0440\u0438\u044E <strong>\"".concat(data.query, "\"</strong>");
                      }
                  ...
                  resultItem: {
                    element: function element(item, data) {
                      ...
                      item.style = "display: flex; justify-content: space-between;"; // Modify Results Item Content
                ...
                autoCompleteJS.input.addEventListener("selection", function (event) {
                  ...
                  autoCompleteJS.input.blur(); // Prepare User's Selected Value

                  var selection = feedback.selection.value; // Render selected choice to selection div

                  document.querySelector(".selection").innerHTML = selection; // Replace Input value with the selected value

                  autoCompleteJS.input.value = selection; // Console log autoComplete data feedback
  ...
  var $listMonths = document.querySelectorAll('#listMonths li');
  $listMonths.forEach(function (month, idx) {
  ...
  var datepickerModal = document.getElementById('datepicker-modal');
